...
We see that the probabilities are generally below 50% and do hover around the algebraic solution of 49.29%
...
We see that this too hovers around the algebraic solution of 47.93%
...
From both mathematical analysis and simulation game, it is clear that the Craps game is close to a fair gamble where the chance for wining is very close to 50&#37;.   However, as it is less than 50&#37; and as the House will play on indefinitely, the House will always come out ahead due to this slight imbalance. 

However, if you are to play the game, the best choice to make would be do a pass-bet.  This has a better chance of winning than a don't-pass bet.  (49.29% versus 47.93%)
