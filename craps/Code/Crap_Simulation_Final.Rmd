---
title: 'ISDA 609 - Mathematical Modeling Techniques for Data Analytics: Final Project #1'
...
Implied the probability of the Shooter loses = `r round((1 - win)*100,2)`&#37;
...
From both mathematical analysis and simulation game, it is clear that the Craps game is close to a fair gamble where chance for wining is very close to 50&#37;. While Casino/House is in bit advantage in Craps gamble, the difference is so small that it does not become significant unless the game runs for indifinitely or casino introduces some further rule(s).
