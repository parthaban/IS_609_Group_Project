...
ssa_allbenefit = read.csv("../Data/OASDI - Table 6.B3 - All Benefit.csv")
ssa_menbenefit = read.csv("../Data/OASDI - Table 6.B3 - Mens Benefit.csv")
ssa_womenbenefit = read.csv("../Data/OASDI - Table 6.B3 - Womens Benefit.csv")
